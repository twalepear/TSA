...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{p1 }\OtherTok{\textless{}{-}}\NormalTok{ BirthAndFertility }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{gg\_lag}\NormalTok{(}\StringTok{\textasciigrave{}}\AttributeTok{Total Fertility Rate (TFR)}\StringTok{\textasciigrave{}}\NormalTok{, }\AttributeTok{geom =} \StringTok{\textquotesingle{}point\textquotesingle{}}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{"Lag Plot of Total Fertility Rate (TFR)"}\NormalTok{)}
\NormalTok{p2 }\OtherTok{\textless{}{-}}\NormalTok{ BirthAndFertility }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{gg\_lag}\NormalTok{(}\StringTok{\textasciigrave{}}\AttributeTok{Total Live{-}Births}\StringTok{\textasciigrave{}}\NormalTok{, }\AttributeTok{geom =} \StringTok{\textquotesingle{}point\textquotesingle{}}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{"Lag Plot of Total Live{-}Births (TLB)"}\NormalTok{)}
\NormalTok{p1 }\SpecialCharTok{+}\NormalTok{ p2 }\CommentTok{\# placing the plots side by side}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{Report_files/Report_files/figure-latex/page-4-1.pdf}}

The above lag plots for TFR and TLB indicate stronger positive
relationships at lags 1 and 2 suggesting that AR(1) and AR(2) models
could be appropriate.

The following fitted AR(1) and AR(2) models (orange lines) follow the
TFR and TLB (grey lines) but tends to overshoots and underestimate
peaks. Residuals were examined and appear to have no pattern; however
the ACF plots show multiple spikes outside the significance bounds
indicating the residuals are not white noise. This indicates that an
ARIMA model, which can account for trend, may be more appropriate.

\newpage

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{TFR\_ar }\OtherTok{\textless{}{-}}\NormalTok{ BirthAndFertility }\SpecialCharTok{|\textgreater{}} \FunctionTok{model}\NormalTok{(}\FunctionTok{AR}\NormalTok{(}\StringTok{\textasciigrave{}}\AttributeTok{Total Fertility Rate (TFR)}\StringTok{\textasciigrave{}}\NormalTok{, }\AttributeTok{order =} \DecValTok{1}\NormalTok{)) }\CommentTok{\# fits AR model}
\NormalTok{TFR\_fits }\OtherTok{\textless{}{-}} \FunctionTok{augment}\NormalTok{(TFR\_ar) }\CommentTok{\# adds columns of data}
\FunctionTok{ggplot}\NormalTok{(TFR\_fits, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Year)) }\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\StringTok{\textasciigrave{}}\AttributeTok{Total Fertility Rate (TFR)}\StringTok{\textasciigrave{}}\NormalTok{), }\AttributeTok{colour =} \StringTok{"grey"}\NormalTok{) }\SpecialCharTok{+} \CommentTok{\# raw data}
  \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\NormalTok{ .fitted), }\AttributeTok{colour =} \StringTok{"\#D55E00"}\NormalTok{) }\SpecialCharTok{+} \CommentTok{\# }
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{"Plot of AR(1) fitted model (orange) and raw data (grey) for TFR"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics[width=0.7\linewidth]{Report_files/figure-latex/page-5-1} \end{center}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{TLB\_ar }\OtherTok{\textless{}{-}}\NormalTok{ BirthAndFertility }\SpecialCharTok{|\textgreater{}} \FunctionTok{model}\NormalTok{(}\FunctionTok{AR}\NormalTok{(}\StringTok{\textasciigrave{}}\AttributeTok{Total Live{-}Births}\StringTok{\textasciigrave{}}\NormalTok{, }\AttributeTok{order =} \DecValTok{1}\NormalTok{))}
\NormalTok{TLB\_fits }\OtherTok{\textless{}{-}} \FunctionTok{augment}\NormalTok{(TLB\_ar)}
\FunctionTok{ggplot}\NormalTok{(TLB\_fits, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Year)) }\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\StringTok{\textasciigrave{}}\AttributeTok{Total Live{-}Births}\StringTok{\textasciigrave{}}\NormalTok{), }\AttributeTok{colour =} \StringTok{"grey"}\NormalTok{) }\SpecialCharTok{+} \CommentTok{\# raw data}
  \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\NormalTok{ .fitted), }\AttributeTok{colour =} \StringTok{"\#D55E00"}\NormalTok{) }\SpecialCharTok{+} \CommentTok{\# }
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{"Plot of AR(1) fitted model (orange) and raw data (grey) for TLB"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics[width=0.7\linewidth]{Report_files/figure-latex/page-5-2} \end{center}

\newpage

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{TFR\_ar2 }\OtherTok{\textless{}{-}}\NormalTok{ BirthAndFertility }\SpecialCharTok{|\textgreater{}} \FunctionTok{model}\NormalTok{(}\FunctionTok{AR}\NormalTok{(}\StringTok{\textasciigrave{}}\AttributeTok{Total Fertility Rate (TFR)}\StringTok{\textasciigrave{}}\NormalTok{, }\AttributeTok{order =} \DecValTok{2}\NormalTok{)) }\CommentTok{\# fits AR model}
\NormalTok{TFR\_fits2 }\OtherTok{\textless{}{-}} \FunctionTok{augment}\NormalTok{(TFR\_ar2) }\CommentTok{\# adds columns of data}
\FunctionTok{ggplot}\NormalTok{(TFR\_fits2, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Year)) }\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\StringTok{\textasciigrave{}}\AttributeTok{Total Fertility Rate (TFR)}\StringTok{\textasciigrave{}}\NormalTok{), }\AttributeTok{colour =} \StringTok{"grey"}\NormalTok{) }\SpecialCharTok{+} \CommentTok{\# raw data}
  \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\NormalTok{ .fitted), }\AttributeTok{colour =} \StringTok{"\#D55E00"}\NormalTok{) }\SpecialCharTok{+} \CommentTok{\# }
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{"Plot of AR(2) fitted model (orange) and raw data (grey) for TFR"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics[width=0.7\linewidth]{Report_files/figure-latex/page-6-1} \end{center}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{TLB\_ar2 }\OtherTok{\textless{}{-}}\NormalTok{ BirthAndFertility }\SpecialCharTok{|\textgreater{}} \FunctionTok{model}\NormalTok{(}\FunctionTok{AR}\NormalTok{(}\StringTok{\textasciigrave{}}\AttributeTok{Total Live{-}Births}\StringTok{\textasciigrave{}}\NormalTok{, }\AttributeTok{order =} \DecValTok{2}\NormalTok{))}
\NormalTok{TLB\_fits2 }\OtherTok{\textless{}{-}} \FunctionTok{augment}\NormalTok{(TLB\_ar2)}
\FunctionTok{ggplot}\NormalTok{(TLB\_fits2, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Year)) }\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\StringTok{\textasciigrave{}}\AttributeTok{Total Live{-}Births}\StringTok{\textasciigrave{}}\NormalTok{), }\AttributeTok{colour =} \StringTok{"grey"}\NormalTok{) }\SpecialCharTok{+} \CommentTok{\# raw data}
  \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\NormalTok{ .fitted), }\AttributeTok{colour =} \StringTok{"\#D55E00"}\NormalTok{) }\SpecialCharTok{+} \CommentTok{\# }
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{"Plot of AR(2) fitted model (orange) and raw data (grey) for TLB"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics[width=0.7\linewidth]{Report_files/figure-latex/page-6-2} \end{center}
\newpage

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{gg\_tsresiduals}\NormalTok{(TFR\_ar) }\SpecialCharTok{+} \CommentTok{\# check residuals}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{"AR(1) model Residuals for TFR"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics[width=0.85\linewidth]{Report_files/figure-latex/page-7-1} \end{center}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{gg\_tsresiduals}\NormalTok{(TLB\_ar) }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{"AR(1) model Residuals for TLB"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics[width=0.85\linewidth]{Report_files/figure-latex/page-7-2} \end{center}

\newpage

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{gg\_tsresiduals}\NormalTok{(TFR\_ar2) }\SpecialCharTok{+} \CommentTok{\# check residuals}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{"AR(2) model Residuals for TFR"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics[width=0.85\linewidth]{Report_files/figure-latex/page-8-1} \end{center}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{gg\_tsresiduals}\NormalTok{(TLB\_ar2) }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{"AR(2) model Residuals for TLB"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics[width=0.85\linewidth]{Report_files/figure-latex/page-8-2} \end{center}
...
\NormalTok{BirthAndFertility }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ACF}\NormalTok{(}\StringTok{\textasciigrave{}}\AttributeTok{Total Fertility Rate (TFR)}\StringTok{\textasciigrave{}}\NormalTok{, }\AttributeTok{lag\_max =} \DecValTok{9}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{autoplot}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{"ACF Plot for Total Fertility Rate (TFR)"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics[width=0.7\linewidth]{Report_files/figure-latex/page-9-1} \end{center}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{BirthAndFertility }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ACF}\NormalTok{(}\StringTok{\textasciigrave{}}\AttributeTok{Total Live{-}Births}\StringTok{\textasciigrave{}}\NormalTok{, }\AttributeTok{lag\_max =} \DecValTok{9}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
\NormalTok{  ggplot2}\SpecialCharTok{::}\FunctionTok{autoplot}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{"ACF Plot for Total Live{-}Births (TLB)"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics[width=0.7\linewidth]{Report_files/figure-latex/page-9-2} \end{center}
