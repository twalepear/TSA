...
TFRm1412 <- Arima(TFR$`Total Fertility Rate (TFR)`, order=c(14,1,2))
TFRm1412 # AIC=-60.26
res1412 <- residuals(TFRm1412)
acf(res1412, lag.max = 50, main = "ACF of Residuals for ARIMA(14,1,2) for TFR")
pacf(res1412, lag.max = 50, main = "PACF of Residuals for ARIMA(14,1,2) for TFR")
```
