...
TFRm1414 <- Arima(TFR$`Total Fertility Rate (TFR)`, order=c(14,1,4))
TFRm1414 # AIC=-59.2
res1414 <- residuals(TFRm1414)
acf(res1414, lag.max = 50, main = "ACF of Residuals for ARIMA(14,1,4) for TFR")
pacf(res1414, lag.max = 50, main = "PACF of Residuals for ARIMA(14,1,4) for TFR")
```

\newpage
```{r page-1f TFR, echo = FALSE, warning = FALSE, message = FALSE, out.width = "70%", fig.align = 'center'}
TFRm1314 <- Arima(TFR$`Total Fertility Rate (TFR)`, order=c(13,1,4))
TFRm1314 # AIC=-58.04
res1314 <- residuals(TFRm1314)
acf(res1314, lag.max = 50, main = "ACF of Residuals for ARIMA(13,1,4) for TFR")
pacf(res1314, lag.max = 50, main = "PACF of Residuals for ARIMA(13,1,4) for TFR")
```

\newpage
```{r page-1g TFR, echo = FALSE, warning = FALSE, message = FALSE, out.width = "70%", fig.align = 'center'}
TFRm1214 <- Arima(TFR$`Total Fertility Rate (TFR)`, order=c(12,1,4))
TFRm1214 # AIC=-54.2
res1214 <- residuals(TFRm1214)
acf(res1214, lag.max = 50, main = "ACF of Residuals for ARIMA(12,1,4) for TFR")
pacf(res1214, lag.max = 50, main = "PACF of Residuals for ARIMA(12,1,4) for TFR")
```
