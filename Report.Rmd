...
```{r page-1, echo = FALSE, warning = FALSE, message = FALSE}
...
\newpage
```{r page-6, echo = FALSE, warning = FALSE, message = FALSE, out.width = "70%", fig.align = 'center'}
BirthAndFertility |>
  PACF(`Total Fertility Rate (TFR)`, lag_max = 24) |>
  autoplot() +
  labs(title = "PACF Plot for Total Fertility Rate (TFR)")
BirthAndFertility |>
  PACF(`Total Live-Births`, lag_max = 24) |>
  ggplot2::autoplot() +
  labs(title = "PACF Plot for Total Live-Births (TLB)")
```

\newpage
```{r page-7, echo = FALSE, warning = FALSE, message = FALSE, out.width = "70%", fig.align = 'center'}
BirthAndFertility |>
...
\newpage
```{r page-8, echo = FALSE, warning = FALSE, message = FALSE, out.width = "70%", fig.align = 'center'}
BirthAndFertility |>
  PACF(diff(`Total Fertility Rate (TFR)`, lag_max = 24)) |>
  autoplot() +
  labs(title = "PACF Plot for Differenced Total Fertility Rate (TFR)")
