...
plot(diff(BirthAndFertility$`Total Fertility Rate (TFR)`), type = 'l') +
  labs(title = "Plot of Differenced Total Fertility Rate (TFR)")
plot(diff(TFR$`Total Fertility Rate (TFR)`), type = 'l') +
  labs(title = "Plot of Differenced Total Fertility Rate (TFR) until 2012")
```
...
BirthAndFertility |>
  ACF(diff(`Total Fertility Rate (TFR)`), lag_max = 40) |>
  autoplot() +
  labs(title = "ACF Plot for Differenced Total Fertility Rate (TFR)")
BirthAndFertility |>
  PACF(diff(`Total Fertility Rate (TFR)`), lag_max = 40) |>
  autoplot() +
...
TFRm0 <- BirthAndFertility |>
  model(ARIMA(`Total Fertility Rate (TFR)` ~ pdq(1,1,0)))
report(TFRm0) # to see the AIC
```
