...
TFRm1222 <- Arima(TFR$`Total Fertility Rate (TFR)`, order=c(12,2,2))
TFRm1222 # AIC=-56.03 AICc=-44.36
res1222 <- residuals(TFRm1222)
acf(res1222, lag.max = 50, main = "ACF of Residuals for ARIMA(12,2,2) for TFR")
pacf(res1222, lag.max = 50, main = "PACF of Residuals for ARIMA(12,2,2) for TFR")
```
