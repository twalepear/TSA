...
TFRm1221 <- Arima(TFR$`Total Fertility Rate (TFR)`, order=c(12,2,1))
TFRm1221 # AIC=-56.03 AICc=-44.36
res1221 <- residuals(TFRm1221)
acf(res1221, lag.max = 50, main = "ACF of Residuals for ARIMA(12,2,1) for TFR")
pacf(res1221, lag.max = 50, main = "PACF of Residuals for ARIMA(12,2,1) for TFR")
```
