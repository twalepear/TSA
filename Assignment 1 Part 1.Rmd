...
TFR_lm <- BirthAndFertility |> model(lm = TSLM(`Total Fertility Rate (TFR)` ~ trend()))
# summaries
tidy(TFR_lm)
glance(TFR_lm)

TLB_lm <- BirthAndFertility |> model(lm = TSLM(`Total Live-Births` ~ trend()))
# summaries
tidy(TLB_lm)
glance(TLB_lm)

\newpage
```{r page-, out.width = "70%", fig.align = 'center'}
BirthAndFertility |>
